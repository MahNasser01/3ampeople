...
function Interviewers() {
  ...
  function InterviewersLoader() {
    return (
      <>
        <div className="flex">
          <div className="h-40 w-36 ml-1 mr-3 flex-none animate-pulse rounded-xl bg-orange-100" />
          <div className="h-40 w-36 ml-1 mr-3 flex-none animate-pulse rounded-xl bg-orange-100" />
          <div className="h-40 w-36 ml-1 mr-3 flex-none animate-pulse rounded-xl bg-orange-100" />
        </div>
      </>
    ...
    <main className="p-8 pt-0 ml-12 mr-auto rounded-md">
      <div className="flex flex-col items-left">
        <div className="flex flex-row mt-5">
          <div>
            <h2 className="mr-2 text-3xl font-bold tracking-tight mt-3 text-gray-800">
              Interviewers
            </h2>
        ...
        <div className="relative flex items-center mt-2 ">
          ...
          {interviewers.length > 4 ? (
            <div className="flex-row justify-center items-center space-y-10">
              <ChevronRight
                className="opacity-50 cursor-pointer hover:opacity-100 text-orange-500 hover:text-orange-600 transition-colors duration-200"
                size={40}
                onClick={slideRight}
              />
              <ChevronLeft
