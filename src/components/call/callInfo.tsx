...
function CallInfo({
  ...
  return (
    <div className="h-screen z-[10] mx-4 mb-[100px] overflow-y-scroll">
      {isLoading ? (
        ...
        <>
              ...
              <div className="flex flex-col justify-between gap-3 w-full">
                <div className="flex flex-row justify-between">
                  ...
                  <div className="flex flex-row mr-2 items-center gap-3">
                    ...
                    >
                      <SelectTrigger className="w-[180px] bg-orange-50/50 rounded-2xl border-orange-200 focus:border-orange-500">
                  ...
                  <div className="flex flex-row gap-2 align-middle">
                    <CircularProgress
                      classNames={{
                        ...
                        value: "text-3xl font-semibold text-orange-600",
                      }}
          ...
          <div className="bg-gradient-to-br from-orange-50 to-orange-100 rounded-3xl min-h-[150px] max-h-[500px] p-6 mb-[150px] border border-orange-200 shadow-xl">
            ...
            <ScrollArea className="rounded-2xl text-sm h-96 overflow-y-auto whitespace-pre-line px-2 bg-white/60 backdrop-blur-sm border border-orange-100">
              <div
                className="text-sm p-6 rounded-2xl leading-6 bg-white/80 backdrop-blur-sm"
