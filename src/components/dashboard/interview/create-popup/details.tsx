      ...
      <div className="text-center w-[38rem]">
        ...
        <div className="flex flex-col justify-center items-start mt-4 ml-10 mr-8">
          <div className="flex flex-row justify-center items-center">
            ...
            <input
              type="text"
              className="border-b-2 focus:outline-none focus:border-orange-500 border-gray-300 px-3 w-96 py-1 ml-3 transition-colors duration-200 rounded-t-md bg-orange-50/30"
            ...
            >
              {interviewers.map((item, key) => (
                ...
                >
                  ...
                  >
                    <Info size={18} color="#ea580c" strokeWidth={2.2} />
                  </button>
                  <div
          ...
          <div className="flex flex-row w-full justify-center items-center space-x-24 mt-5">
            <Button
              ...
              className="bg-orange-500 hover:bg-orange-600 text-white font-medium w-40 transition-colors duration-200 shadow-md hover:shadow-lg"
              onClick={() => {
                setIsClicked(true);
                onGenrateQuestions();
              }}
            ...
            <Button
              ...
              className="bg-orange-500 w-40 hover:bg-orange-600 text-white font-medium transition-colors duration-200 shadow-md hover:shadow-lg"
              onClick={() => {
                setIsClicked(true);
                onManual();
              }}
